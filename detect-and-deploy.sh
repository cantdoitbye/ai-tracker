...
# AI Bot Detect - Universal Deployment Script
...
if [ -f /etc/os-release ]; then
    ...
    echo "Cannot detect OS. This script supports CentOS, RHEL, Ubuntu, and Debian."
    exit 1
fi
...
if [[ "$OS" == "centos" ]] || [[ "$OS" == "rhel" ]] || [[ "$OS" == "rocky" ]] || [[ "$OS" == "almalinux" ]]; then
    ...
    echo "This script supports CentOS, RHEL, Ubuntu, and Debian."
    exit 1
fi
...
if [[ "$PKG_MANAGER" == "yum" ]] || [[ "$PKG_MANAGER" == "dnf" ]]; then
    ...
    $PKG_INSTALL gcc gcc-c++ make nginx certbot python3-certbot-nginx git curl firewalld
    ...
    # Ubuntu/Debian
    $PKG_INSTALL python3-pip python3-venv nginx certbot python3-certbot-nginx git curl ufw
fi

# Install Python 3.11 (required for dependencies)
echo "Step 3/11: Installing Python 3.11..."
if [[ "$PKG_MANAGER" == "yum" ]] || [[ "$PKG_MANAGER" == "dnf" ]]; then
    # AlmaLinux/CentOS/RHEL - Install Python 3.11
    $PKG_INSTALL python3.11 python3.11-pip python3.11-devel
    PYTHON_CMD="python3.11"
    PYTHON_VENV="python3.11 -m venv"
    ...
    # Ubuntu/Debian - Python 3.10+ should be available
...
echo "Step 4/11: Installing Node.js 20 LTS..."
...
# Install MongoDB
echo "Step 5/11: Installing MongoDB..."
...
# Create app user
echo "Step 6/11: Creating application user..."
if ! id -u appuser > /dev/null 2>&1; then
    useradd -m -s /bin/bash appuser
fi

# Clone repository
echo "Step 7/11: Cloning repository from GitHub..."
...
# Setup backend
echo "Step 8/11: Setting up backend..."
cd /home/appuser/app/backend

# Create virtual environment
sudo -u appuser $PYTHON_VENV venv
...
echo "Step 9/11: Creating backend service..."
...
# Build frontend
echo "Step 10/11: Building frontend..."
...
# Set SELinux to permissive if on CentOS/RHEL
if [[ "$PKG_MANAGER" == "yum" ]] || [[ "$PKG_MANAGER" == "dnf" ]]; then
    if command -v setenforce &> /dev/null; then
        setenforce 0 2>/dev/null || echo "SELinux already disabled or in permissive mode"
...
# Setup SSL
echo "Step 12/12: Setting up SSL certificates..."
...
echo "  Frontend Nginx: /etc/nginx/conf.d/aibot-frontend.conf"
echo "  Backend Nginx: /etc/nginx/conf.d/aibot-backend.conf"
